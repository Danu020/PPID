...
@section('title', 'Beranda - Prosedur Permohonan Informasi')
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            @empty
                ...
                <div class="bg-white rounded-lg shadow-md p-12 text-center">
                    ...
                    <h3 class="text-lg font-medium text-gray-900 mb-2">Tidak ada dokumen Prosedur Permohonan Informasi</h3>
                    <p class="text-gray-500">Dokumen Prosedur Permohonan Informasi akan ditampilkan di sini ketika tersedia.</p>
                </div>
            @endforelse
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm" style="color: #004878;">
                            <strong>Catatan:</strong> Prosedur Permohonan Informasi ini merupakan komitmen PPID Politeknik Negeri
