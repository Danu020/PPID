            ...
            <form action="{{ route('permohonaninformasi.update', $permohonaninformasi->id) }}" 
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="nama_pemohon" class="form-control" 
                            ...
                            value="{{ old('nama_pemohon', $permohonaninformasi->nama_pemohon ?? '') }}" required>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="form-label">NIK</label>
                        <input type="text" name="nik" class="form-control" 
                            placeholder="Masukkan NIK" 
                            value="{{ old('nik', $permohonaninformasi->nik ?? '') }}" required>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="nomor_telepon" class="form-control" 
                            ...
                            value="{{ old('nomor_telepon', $permohonaninformasi->nomor_telepon ?? '') }}" required>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="form-label">Email</label>
                        <input type="email" name="email" class="form-control" 
                            placeholder="Masukkan email aktif" 
                            value="{{ old('email', $permohonaninformasi->email ?? '') }}" required>
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea name="informasi_yang_dibutuhkan" class="form-control" rows="3" 
                        placeholder="Tuliskan informasi yang dibutuhkan" required>{{ old('informasi_yang_dibutuhkan', $permohonaninformasi->informasi_yang_dibutuhkan ?? '') }}</textarea>
                </div>

                <div class="mb-3">
                    <label class="form-label">Alasan Permohonan</label>
                    <textarea name="alasan_permohonan" class="form-control" rows="3" 
                        placeholder="Tuliskan alasan permohonan" required>{{ old('alasan_permohonan', $permohonaninformasi->alasan_permohonan ?? '') }}</textarea>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea name="catatan" class="form-control" rows="2" placeholder="Catatan tambahan (opsional)">{{ old('catatan', $permohonaninformasi->catatan ?? '') }}</textarea>
                </div>
